    ...
    return (
      ...
      (_this.liClasses = function(time, currH, currM) {
        ...
        if (
          ...
          (getHour(time) * 60 + getMinute(time)) % _this.props.intervals !== 0
        ) {
            ...
            "li",
            {
              ...
              ref: function ref(li) {
                if (
                  ...
                  (currH === getHour(time) && !_this.centerLi)
                ) {
                  _this.centerLi = li;
                }
              }
...
var Calendar = (function(_React$Component) {
  ...
  function Calendar(props) {
    ...
    _this.renderCustomHeader = function(_ref2) {
      ...
      var prevMonthButtonDisabled = allDaysDisabledBefore(
        _this.state.date,
        "month",
        _this.props
      );

      var nextMonthButtonDisabled = allDaysDisabledAfter(
        _this.state.date,
        "month",
        _this.props
      );
...
var DatePicker = (function(_React$Component) {
  ...
  function DatePicker(props) {
    ...
    _this.inputOk = function() {
      return (
        isMoment(_this.state.preSelection) || isDate(_this.state.preSelection)
      );
    };
    ...
    _this.handleChange = function() {
      ...
      var date = selected
        ? selected.clone(parseDate(event.target.value, _this.props))
        : null;
