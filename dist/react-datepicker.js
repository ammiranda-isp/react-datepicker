!(function(e, t) {
  ...
  function U() {
    for (
      ...
      } else if ("object" === (void 0 === a ? "undefined" : G(a))) {
        var p = Object.keys(a),
          c = p[0],
          l = a[p[0]];
  ...
  function z(e) {
    ...
    return t.createElement(
      ...
      t.createElement(
        "div",
        X({ className: "react-datepicker__triangle" }, void 0 === r ? {} : r)
      ),
      n
    );
  }
    ...
    re = (function(e) {
      function n() {
        ...
        for (var s = arguments.length, i = Array(s), p = 0; s > p; p++)
          i[p] = arguments[p];
        return (
          (r = o = $(this, e.call.apply(e, [this].concat(i)))),
      ...
      return (
        (o.renderOptions = function() {
          return o.state.monthYearsList.map(function(e) {
            var n = e.valueOf(),
              r = P(o.props.date, e) && F(o.props.date, e);
            return t.createElement(
              "div",
              {
                className: r
    ...
    ce = (function(e) {
      function n() {
        ...
        return (
          ...
          (o.renderSelectOptions = function() {
            for (
              var e = M(W(o.props.minDate, o.props.locale)),
                n = M(W(o.props.maxDate, o.props.locale)),
                r = [];
              !Y(e, n);
          ...
          (o.renderReadView = function(e) {
            var n = y(W(d(o.props.date), o.props.locale), o.props.dateFormat);
            return t.createElement(
              "div",
              {
                key: "read",
          ...
          (o.renderDropdown = function() {
            return t.createElement(pe, {
              ...
              onChange: o.onChange,
              onCancel: o.toggleDropdown,
              minDate: W(o.props.minDate, o.props.locale),
              maxDate: W(o.props.maxDate, o.props.locale),
          ...
          (o.onChange = function(e) {
            o.toggleDropdown();
            var t = d(parseInt(e));
            (P(o.props.date, t) && F(o.props.date, t)) || o.props.onChange(t);
          }),
          (o.toggleDropdown = function() {
            return o.setState({ dropdownVisible: !o.state.dropdownVisible });
          }),
  ...
  var le = (function(e) {
    function n() {
      ...
      for (var s = arguments.length, i = Array(s), p = 0; s > p; p++)
        i[p] = arguments[p];
      return (
        (t = o = $(this, e.call.apply(e, [this].concat(i)))),
      ...
      (n.prototype.render = function() {
        return t.createElement(
          ...
          this.props.renderDayContents
            ? this.props.renderDayContents(S(this.props.day))
            : S(this.props.day)
        );
      }),
      n
  ...
  le.propTypes = {
    ...
    selectsStart: n.bool,
    startDate: n.object,
    utcOffset: n.oneOfType([n.number, n.string]),
  ...
  var ue = (function(e) {
    function n() {
      ...
      for (var a = arguments.length, s = Array(a), i = 0; a > i; i++)
        s[i] = arguments[i];
      return (
        (t = r = $(this, e.call.apply(e, [this].concat(s)))),
  ...
  ue.propTypes = { weekNumber: n.number.isRequired, onClick: n.func };
  var de = (function(e) {
    function n() {
      var r, o, a;
      J(this, n);
        ...
        (o.renderDays = function() {
          ...
          if (o.props.showWeekNumber) {
            var a = o.props.onWeekSelect
              ...
              : void 0;
            n.push(
              t.createElement(ue, { key: "W", weekNumber: r, onClick: a })
            );
          }
          return n.concat(
    ...
    me = (function(e) {
      function n() {
        ...
        for (var i = arguments.length, p = Array(i), c = 0; i > c; c++)
          p[c] = arguments[c];
        return (
          (o = a = $(this, e.call.apply(e, [this].concat(p)))),
      ...
      return (
        ...
        (o.liClasses = function(e, t, n) {
          ...
          return (
            ...
            o.props.injectTimes &&
              (60 * w(e) + v(e)) % o.props.intervals != 0 &&
    ...
    ge = (function(e) {
        ...
        return (
          ...
          (o.renderPreviousMonthButton = function() {
            if (!o.props.renderCustomHeader) {
              var e = H(o.state.date, "month", o.props);
              if (
          ...
          (o.renderNextMonthButton = function() {
            if (!o.props.renderCustomHeader) {
              var e = V(o.state.date, "month", o.props);
              if (
                (o.props.forceShowMonthNavigation ||
                  o.props.showDisabledMonthNavigation ||
                  !e) &&
          ...
          (o.renderCustomHeader = function(e) {
            ...
            var r = H(o.state.date, "month", o.props),
              a = V(o.state.date, "month", o.props);
            return t.createElement(
              "div",
              {
                className:
      ...
      return (
        ...
        (n.prototype.componentDidUpdate = function(e) {
          this.props.preSelection && !R(this.props.preSelection, e.preSelection)
            ? this.setState({
                date: this.localizeDate(this.props.preSelection)
              })
            : this.props.openToDate &&
              !R(this.props.openToDate, e.openToDate) &&
              this.setState({ date: this.localizeDate(this.props.openToDate) });
        }),
        (n.prototype.render = function() {
          return t.createElement(
            this.props.container || z,
            {
  ...
  var be = [
    ...
    ve = (function(e) {
      function n() {
        return J(this, n), $(this, e.apply(this, arguments));
      }
      return (
        Z(n, e),
        (n.prototype.render = function() {
          ...
          return (
            ...
            t.createElement(
              s.Manager,
              null,
              t.createElement(s.Reference, null, function(e) {
                return t.createElement(
                  "div",
  ...
  var we = "react-datepicker-ignore-onclickoutside",
    ke = o(ge),
    Ce = "Date input not valid.",
    Se = (function(e) {
      function n(o) {
        J(this, n);
        var s = $(this, e.call(this, o));
        return (
          ...
          (s.calcInitialState = function() {
            ...
            return {
              ...
              highlightDates: U(s.props.highlightDates),
              focused: !1
            };
          }),
          ...
          (s.setBlur = function() {
            s.input && s.input.blur && s.input.blur(),
              s.props.onBlur && s.props.onBlur(),
              s.cancelFocusInput();
          }),
          ...
          (s.handleChange = function() {
            ...
            if (
              ...
              var i = r
                ...
                : null;
              (!i && o.target.value) || s.setSelected(i, o, !0);
            }
          }),
          ...
          (s.setSelected = function(e, t, n) {
            ...
            if (null !== r && B(r, s.props))
              (function(e) {
                ...
                (s.props.onChange(e, t), s.props.onSelect(r, t));
            else {
              if (!R(s.props.selected, r) || s.props.allowSameDay) {
                if (null !== r) {
                  if (s.props.selected) {
          ...
          (s.onInputKeyDown = function(e) {
            ...
            if (s.state.open || s.props.inline || s.props.preventOpenOnFocus) {
              ...
              if ("Enter" === t)
                e.preventDefault(),
                  s.inputOk() && s.state.lastPreSelectChange === Me
                    ? (s.handleSelect(n, e),
                ...
                e.preventDefault(),
                  s.setOpen(!1),
                  s.inputOk() || s.props.onInputError({ code: 1, msg: Ce });
                ...
                if (!r)
                  return void (
                    ...
                    s.props.onInputError({ code: 1, msg: Ce })
                  );
                e.preventDefault(),
                  s.setState({ lastPreSelectChange: Me }),
          ...
          (s.renderDateInput = function() {
            var e,
              n,
              o = r(s.props.className, ((e = {}), (e[we] = s.state.open), e)),
              i =
                s.props.customInput ||
        ...
        (n.prototype.componentDidUpdate = function(e, t) {
          e.inline &&
            ...
            e.highlightDates !== this.props.highlightDates &&
              this.setState({ highlightDates: U(this.props.highlightDates) }),
            !t.focused &&
              (function(e, t) {
                return !(
                  !e ||
